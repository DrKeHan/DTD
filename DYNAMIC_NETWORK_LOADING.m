function [delay, Nup, Ndn]=DYNAMIC_NETWORK_LOADING(pathDepartures, nt, dt, processedDataFile)
...
%
% DOCUMENTATION: 
%        Han, Eve, Friesz (2018) Computing dynamic user equilibria on large-scale
%        networks: Algorithms and software implementation. Networks and
%        Spatial Economics.
%
% **************************************************
